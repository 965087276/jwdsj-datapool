...
import cn.ict.jwdsj.datapool.dictionary.entity.column.dto.DictColumnAddDTO;
...
public class DictColumnServiceImpl implements DictColumnService {
    ...
    public void delete(long id) {
        ...
        // 该字段所在表不能加入到搜索引擎中
        Assert.isTrue(!dictTableRepo.findById(dictColumn.getTableId()).get().isAddToSe(), "该字段所在的表已经加入到搜索引擎表中，请从搜索引擎表中删除该表");
