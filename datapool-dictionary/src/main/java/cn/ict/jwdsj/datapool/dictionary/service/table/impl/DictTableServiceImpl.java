package cn.ict.jwdsj.datapool.dictionary.service.table.impl;
...
import cn.ict.jwdsj.datapool.dictionary.entity.table.dto.DictTableDTO;
...
import static cn.ict.jwdsj.datapool.common.constant.DictType.*;
...
//    }
    ...
    public void saveAll(DictTableMultiAddDTO dictTableMultiAddDTO) {
        DictDatabase dictDatabase = dictDatabaseRepo.findById(dictTableMultiAddDTO.getDatabaseId()).get();
    ...
    public void delete(long id) {
        ...
        // 删除所有字段
        dictColumnRepo.deleteAllByTableId(id);
        // 删除该表
        dictTableRepo.deleteById(id);
        publisher.publishEvent(new DictDeleteEvent(id, COLUMNS));
